...
static void gatts_profile_event_handler(esp_gatts_cb_event_t event, esp_gatt_if_t gatts_if, esp_ble_gatts_cb_param_t *param)
{
    ...
    case ESP_GATTS_REG_EVT:
        ...
        gatts_profile.service_id.id.uuid.uuid.uuid16 = GATTS_SERVICE_UUID_TEST;
        ...
        esp_ble_gatts_create_service(gatts_if, &gatts_profile.service_id, GATTS_NUM_HANDLE_TEST);
        break;
